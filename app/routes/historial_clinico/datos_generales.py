...
@historial_clinico_bp.route("/<int:historial_id>/datos-generales", methods=["GET", "POST"])
@login_required
def historial_clinico_datos_generales(paciente_id, historial_id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(
            url_for("historial_clinico.historial_clinico_area_social", 
